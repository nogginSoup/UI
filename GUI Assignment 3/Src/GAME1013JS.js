...
var swimBtn = document.getElementById("swimHud");
swimBtn.addEventListener("click", SwimHud);
var mapBtn = document.getElementById("map");
mapBtn.addEventListener("click", MapHud);
var missionBtn = document.getElementById("missions");
missionBtn.addEventListener("click", MissHud);
...
var swimHud = new Image();
var mapHud = new Image();
var missHud = new Image();
...
swimHud.src = "../img/HUD.png";
mapHud.src = "../img/Map.png";
missHud.src = "../img/missions.png";
returnbutton.src = "../img/Main Screen.png";
...
function SwimHud(){
	game.drawImage(swimHud,1,1);
}

function MapHud(){
	game.drawImage(mapHud,1,1);
}

function MissHud(){
	game.drawImage(missHud,1,1);
}

function ReturnButton(){
	game.drawImage(returnbutton,1,1);
}
function GameOver(){
